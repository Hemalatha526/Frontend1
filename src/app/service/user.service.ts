...
export class UserService {
  ...
  logout(){
    ...
    return this._http.post('https://comtweetapp.azurewebsites.net/api/v1/tweets/logout',null,options);
  }

  login(userId: string, password: string):Observable<any> {
    const body = { userId: userId, password: password };
    return this._http.post('https://comtweetapp.azurewebsites.net/api/v1/tweets/login',body);
  }
  ...
  register(
    ...
    return this._http.post('https://comtweetapp.azurewebsites.net/api/v1/tweets/register',body);
  }
  ...
  forgotPassword(
    ...
    return this._http.post('https://comtweetapp.azurewebsites.net/api/v1/tweets/forgot',body);
  }
  ...
  allUser():Observable<any> {
    ...
    return this._http.get(
      'https://comtweetapp.azurewebsites.net/api/v1/tweets/users/all', options);
  }
  ...
  searchUser(name:string):Observable<any> {
    ...
    return this._http.get(
      'https://comtweetapp.azurewebsites.net/api/v1/tweets/search', options);
  }
}
